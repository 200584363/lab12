...
document.addEventListener("DOMContentLoaded", function () {
    // STEP 2a: Grab the UL for #blockGallery and assign it to the variable 'blockGallery' - using document.getElementById
    let blockGallery = document.getElementById("blockGallery");
    
    // STEP 2b: Create an array called 'blockLinks' to contain all the A elements inside the above variable, 'blockGallery' - using querySelectorAll
    ...
    for (let i = 0; i < blockLinks.length; i++) {
        ...
        blockLinks[i].onclick = function () {
            ...
            // STEP 4b: Grab the IMG element just below the UL containing the links to each of the block images with the appropriate ID and assign it to a variable of the same name - using document.getElementById
            ...
            // STEP 5b: Create another variable called 'blockCaptionParagraph' that represents the P element with the id 'blockCaption' - using getElementById
